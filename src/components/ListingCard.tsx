...
export function ListingCard({ listing, onClaim, showClaimButton }: ListingCardProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "bg-white rounded-2xl border border-slate-200 overflow-hidden transition-all hover:shadow-lg hover:shadow-slate-200/50",
    ...
    >
      <div className="p-5">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="bg-slate-50 p-2 rounded-xl text-center min-w-[60px]">
